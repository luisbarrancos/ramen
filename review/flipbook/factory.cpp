...
factory_t::factory_t() { register_flipbook("internal", &internal_flipbook_t::create); }
...
flipbook_t* factory_t::create(int                frame_rate,
                              const std::string& display_device,
                              const std::string& display_transform) const
{
    return create(
        app().preferences().default_flipbook(), frame_rate, display_device, display_transform);
}

flipbook_t* factory_t::create(const std::string& id,
                              int                frame_rate,
                              const std::string& display_device,
                              const std::string& display_transform) const
{
