...
render_flipbook_dialog_t::render_flipbook_dialog_t()
: QDialog(app().ui()->main_window())
{
    ...
    connect(ui_.ocio_transform_combo_,
...
int render_flipbook_dialog_t::resolution() const
{
...
int render_flipbook_dialog_t::mblur_extra_samples() const
{
    return ui_.mblur_extra_samples_->value();
}
float render_flipbook_dialog_t::mblur_shutter_factor() const
{
    return ui_.mblur_shutter_factor_->value();
}
...
const std::string& render_flipbook_dialog_t::display_transform() const
{
