...
public:
    ...
    typedef boost::function<flipbook_t*(int, const std::string&, const std::string&)>
        create_fun_type;
    ...
    const std::vector<std::pair<std::string, create_fun_type>>&                  flipbooks() const
    {
        return flipbooks_;
    }

    flipbook_t* create(int                frame_rate,
                       const std::string& display_device,
                       const std::string& display_transform) const;

    flipbook_t* create(const std::string& id,
                       int                frame_rate,
                       const std::string& display_device,
                       const std::string& display_transform) const;
