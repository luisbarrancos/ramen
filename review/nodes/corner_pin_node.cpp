...
namespace image
{
corner_pin_node_t::corner_pin_node_t()
: xform2d_node_t()
{
    set_name("corner_pin");
...
corner_pin_node_t::corner_pin_node_t(const corner_pin_node_t& other)
...
{
    std::auto_ptr<quad_manipulator_t> m(
        new quad_manipulator_t(dynamic_cast<float2_param_t*>(&param("topleft")),
...
corner_pin_node_t::matrix3_type corner_pin_node_t::do_calc_transform_matrix_at_frame(
    float frame, int subsample) const
{
    ...
    return matrix3_type(0, 0, 0, 0, 0, 0, 0, 0, 0);
}
...
void corner_pin_node_t::get_corners_at_frame(boost::array<Imath::V2d, 4>& pts,
                                             float                        frame,
                                             float                        scale) const
{
...
const node_metaclass_t* corner_pin_node_t::metaclass() const
{
    return &corner_pin_node_metaclass();
}
...
static bool registered
    = node_factory_t::instance().register_node(corner_pin_node_t::corner_pin_node_metaclass());
