...
lens_distort_node_t::lens_distort_node_t()
: image_node_t()
{
...
lens_distort_node_t::lens_distort_node_t(const lens_distort_node_t& other)
: image_node_t(other)
{
}
...
const node_metaclass_t* lens_distort_node_t::metaclass() const
{
    return &lens_distort_node_metaclass();
}
...
static bool registered
    = node_factory_t::instance().register_node(lens_distort_node_t::lens_distort_node_metaclass());
