...
text_node_t::text_node_t(const text_node_t& other)
...
static bool registered
    = node_factory_t::instance().register_node(text_node_t::text_node_metaclass());
#endif
...
void text_node_t::create_face()
{
    try
    {
        face_ = freetype::font_cache_t::Instance().create_face( get_value<boost::filesystem::path>(
param( "font")));
    }
