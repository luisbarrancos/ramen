...
namespace image
{
autoalign_base_node_t::autoalign_base_node_t()
: xform_node_t()
{
    for (int i = 0; i < 4; ++i)
    {
...
autoalign_base_node_t::autoalign_base_node_t(const autoalign_base_node_t& other)
: xform_node_t(other)
{
    for (int i = 0; i < 4; ++i)
    {
...
// util
float_param_t* autoalign_base_node_t::create_float_param(group_param_t*     g,
...
float2_param_t* autoalign_base_node_t::create_float2_param(group_param_t*     g,
                                                           const std::string& str,
                                                           const Imath::V2f&  value)
{
    RAMEN_ASSERT(g);
