...
namespace ramen
{
se_expr_param_t::se_expr_param_t(const std::string&          name,
                                 const create_expr_fun_type& create_expr_fun)
: static_param_t(name)
{
...
se_expr_param_t::se_expr_param_t(const se_expr_param_t& other)
...
void se_expr_param_t::show_expression_editor()
{
    ...
    ui::expression_editor_callback_suite_t cback( boost::bind( &se_expr_param_t::expr_editor_accept,
    this, _1), boost::bind( &se_expr_param_t::expr_editor_apply, this, _1), boost::bind(
    &se_expr_param_t::expr_editor_cancel, this));
