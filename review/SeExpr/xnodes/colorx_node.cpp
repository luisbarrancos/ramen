...
colorx_node_t::colorx_node_t(const colorx_node_t& other)
...
void colorx_node_t::do_expression(const tbb::blocked_range<int>& range,
...
static bool registered
    = node_factory_t::instance().register_node(colorx_node_t::colorx_node_metaclass());
