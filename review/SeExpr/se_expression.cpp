...
{
se_expression_t::se_expression_t()
: SeExpression()
{
}
se_expression_t::se_expression_t(const std::string& e, bool wantVec)
: SeExpression(e, wantVec)
{
}
...
const std::string& se_expression_t::getExpr() const { return SeExpression::getExpr(); }
