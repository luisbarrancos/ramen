...
namespace ofx
{
ofx_manipulator_t::ofx_manipulator_t(ofx_node_t* node, image_effect_t* effect)
: manipulator_t()
...
bool ofx_manipulator_t::key_press_event(ui::image_view_t& view, QKeyEvent* event) { return false; }
