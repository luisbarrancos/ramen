...
: OFX::Host::Param::RGBAInstance(descriptor, instance)
{
...
OfxStatus rgba_color_param_t::copy(const OFX::Host::Param::Instance& instance,
                                   OfxTime                           offset,
                                   OfxRangeD                         range)
{
    const rgba_color_param_t* other = dynamic_cast<const rgba_color_param_t*>(&instance);
...
{
    const color_param_t& param(
        dynamic_cast<const color_param_t&>(effect_->node()->param(getName())));
