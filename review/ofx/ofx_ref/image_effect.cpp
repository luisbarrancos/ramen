...
OFX::Host::ImageEffect::ClipInstance* image_effect_t::newClipInstance(
...
OfxStatus image_effect_t::vmessage(const char* type,
                                   const char* id,
                                   const char* format,
                                   va_list     args)
{
...
OFX::Host::Param::Instance* image_effect_t::newParam(const std::string&            name,
...
{
    return OFX::Host::ImageEffect::Instance::paramInstanceChangedAction(
        paramName, why, time, renderScale);
}
...
OfxStatus image_effect_t::clipInstanceChangedAction(const std::string& clipName,
                                                    ...
                                                    OfxPointD          renderScale)
{
    return OFX::Host::ImageEffect::Instance::clipInstanceChangedAction(
        clipName, why, time, renderScale);
}
