...
plugin_manager_t::plugin_manager_t()
{
    ...
    std::map<std::string, OFX::Host::ImageEffect::ImageEffectPlugin*>::const_iterator it(
        imageEffectPluginCache_->getPluginsByID().begin());
    std::map<std::string, OFX::Host::ImageEffect::ImageEffectPlugin*>::const_iterator end(
        imageEffectPluginCache_->getPluginsByID().end());
...
std::auto_ptr<node_t> plugin_manager_t::create_node_by_label(std::string label)
{
    OFX::Host::ImageEffect::ImageEffectPlugin* plugin
        = imageEffectPluginCache_->getPluginByLabel(label);
...
OFX::Host::ImageEffect::ImageEffectPlugin* plugin_manager_t::get_plugin_by_id(const std::string& id,
                                                                              int major,
                                                                              int minor)
{
