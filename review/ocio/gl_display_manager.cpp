...
std::pair<core::string8_t, core::string8_t> gl_display_manager_t::default_get_ctx( int i)
{
    return std::make_pair( core::string8_t(), core::string8_t());
}
...
OCIO::ConstContextRcPtr gl_display_manager_t::get_local_context()
{
    ...
    // TODO: gcc 4.7 has some problems with std::pair assignment
    // check it.
    /*
    OCIO::ContextRcPtr mutable_context;

    std::pair<core::string8_t, core::string8_t> ctx_pair( get_ctx_fun_( 0));
    ...
    ctx_pair = std::pair<core::string8_t, core::string8_t>( get_ctx_fun_( 1));
    ...
    ctx_pair = std::pair<core::string8_t, core::string8_t>( get_ctx_fun_( 2));
    ...
    ctx_pair = std::pair<core::string8_t, core::string8_t>( get_ctx_fun_( 3));
