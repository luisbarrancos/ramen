...
namespace image
{
gray_gaussian_pyramid_t::gray_gaussian_pyramid_t(int width, int height, float ratio, int min_width)
: gray_pyramid_t(width, height, ratio, min_width)
{
}
...
void gray_gaussian_pyramid_t::build()
{
    ...
    for (int i = 1; i < num_levels_; ++i)
    {
        ...
        gaussian_blur_gray(const_view(i - 1),
                           boost::gil::subimage_view(tmp2.gray_view(), 0, 0, h, w),
                           tmp_view,
                           sigma,
                           sigma);
...
rgb_gaussian_pyramid_t::rgb_gaussian_pyramid_t(int width, int height, float ratio, int min_width)
: rgb_pyramid_t(width, height, ratio, min_width)
{
}
...
void rgb_gaussian_pyramid_t::build()
{
    ...
    for (int i = 1; i < num_levels_; ++i)
    {
        ...
        gaussian_blur_rgb(const_view(i - 1),
                          boost::gil::subimage_view(tmp2.rgb_view(), 0, 0, h, w),
                          tmp_view,
                          sigma,
                          sigma);
        scale_view(tmp_view, view(i));
...
rgba_gaussian_pyramid_t::rgba_gaussian_pyramid_t(int width, int height, float ratio, int min_width)
: rgba_pyramid_t(width, height, ratio, min_width)
{
}
...
void rgba_gaussian_pyramid_t::build()
{
    ...
    for (int i = 1; i < num_levels_; ++i)
    {
        ...
        gaussian_blur_rgba(const_view(i - 1),
                           boost::gil::subimage_view(tmp2.rgba_view(), 0, 0, h, w),
                           tmp_view,
                           sigma,
                           sigma);
        scale_view(tmp_view, view(i));
