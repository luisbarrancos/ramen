...
static void    ConvertToBezierForm();
 ...
 */
static void ConvertToBezierForm(Point2 P, Point2* V, Point2* w)
/*
...
*/
{
    ...
    double dists[W_DEGREE + 1];

    assert(degree <= W_DEGREE);
