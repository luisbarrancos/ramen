    ...
    agg::cover_type   cover)
{
    ...
    do
    {
        get_color(*p, red_t()) = (get_color(*p, red_t()) * inv_alpha) +
                                 (get_color(c, red_t()) * alpha);
        get_color(*p, green_t()) = (get_color(*p, green_t()) * inv_alpha) +
                                   (get_color(c, green_t()) * alpha);
        get_color(*p, blue_t()) = (get_color(*p, blue_t()) * inv_alpha) +
                                  (get_color(c, blue_t()) * alpha);
