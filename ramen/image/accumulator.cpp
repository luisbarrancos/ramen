  ...
  : view_(view)
{
    defined_ = Imath::Box2i(
        Imath::V2i(0, 0), Imath::V2i(view.width() - 1, view.height() - 1));
}

rgba_accumulator_t::rgba_accumulator_t(
...
void rgba_accumulator_t::accumulate(
    ...
    float                     factor)
{
    ...
    image_view_t dst_view = boost::gil::subimage_view(
        view_,
    ...
    const_image_view_t src_view = boost::gil::subimage_view(
        v,
...
void rgba_accumulator_t::multiply(float f)
{
    mul_image_scalar(view_, f, view_);
}
...
gray_accumulator_t::gray_accumulator_t(
...
void gray_accumulator_t::accumulate(
    ...
    float                          factor)
{
    ...
    gray_image_view_t dst_view = boost::gil::subimage_view(
        view_,
        isect.min.x - defined_.min.x,
        isect.min.y - defined_.min.y,
        isect.size().x + 1,
    ...
    const_gray_image_view_t src_view = boost::gil::subimage_view(
        v,
        isect.min.x - area.min.x,
        isect.min.y - area.min.y,
        isect.size().x + 1,
