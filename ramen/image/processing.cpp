...
boost::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
    add_images = sse2::add_images;
boost::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
    sub_images = sse2::sub_images;
boost::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
                                                                             mul_images = sse2::mul_images;
boost::function<void(const const_image_view_t&, float, const image_view_t&)> mul_image_scalar
    = sse2::mul_image_scalar;
boost::function<void(
    const const_image_view_t&, const const_image_view_t&, float, const image_view_t&)>
...
boost::function<void(
    const const_channel_view_t&, const const_channel_view_t&, const channel_view_t&)>
...
boost::function<void(
    const const_channel_view_t&, const const_channel_view_t&, float, const channel_view_t&)>
                                                                                 madd_channels = generic::madd_channels;
boost::function<void(const const_channel_view_t&, float, const channel_view_t&)> mul_channel_scalar
    = generic::mul_channel_scalar;

boost::function<void(const gray_image_view_t&)> clear_gray_image;
boost::function<void(
    const const_gray_image_view_t&, const const_gray_image_view_t&, const gray_image_view_t&)>
...
boost::function<void(const const_gray_image_view_t&, float, const gray_image_view_t&)>
    mul_gray_image_scalar = generic::mul_gray_image_scalar;
boost::function<void(const const_gray_image_view_t&,
...
// channels
boost::function<void(const const_image_view_t&, const image_view_t&)> premultiply
    = generic::premultiply;
boost::function<void(const const_image_view_t&, const image_view_t&)> unpremultiply
    = generic::unpremultiply;

boost::function<void(const const_image_view_t&, const image_view_t&)> invert_rgba
    = generic::invert_rgba;
boost::function<void(const const_image_view_t&, const image_view_t&)> invert_rgb
    = generic::invert_rgb;
boost::function<void(const const_image_view_t&, const image_view_t&)> invert_alpha
    = generic::invert_alpha;
boost::function<void(const const_channel_view_t&, const channel_view_t&)> invert_channel
    = generic::invert_channel;

// color space
boost::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_yuv
    = generic::convert_rgb_to_yuv;
boost::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_hsv
    = generic::convert_rgb_to_hsv;
boost::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_lab
    = generic::convert_rgb_to_lab;

boost::function<void(const const_image_view_t&, const image_view_t&)> convert_yuv_to_rgb
    = generic::convert_yuv_to_rgb;
boost::function<void(const const_image_view_t&, const image_view_t&)> convert_hsv_to_rgb
    = generic::convert_hsv_to_rgb;
boost::function<void(const const_image_view_t&, const image_view_t&)> convert_lab_to_rgb
    = generic::convert_lab_to_rgb;

boost::function<void(const const_image_view_t&, const gray_image_view_t&)> convert_rgb_to_gray
    = generic::convert_rgb_to_gray;

// color
boost::function<void(const const_image_view_t&, const image_view_t&, float)> apply_gamma
    = generic::apply_gamma;
boost::function<void(const const_image_view_t&, const image_view_t&)> apply_log
    = generic::apply_log;
boost::function<void(const const_image_view_t&, const image_view_t&)> apply_pow10
    = generic::apply_pow10;
boost::function<void(const const_image_view_t&, const image_view_t&, const matrix4_t&)>
...
// transform
boost::function<void(const Imath::Box2i&,
...
boost::function<void(const const_image_view_t&, const image_view_t&)> resize_bilinear
    = sse2::resize_bilinear;

boost::function<void(const image::const_image_view_t&,
                     const Imath::Box2i&,
...
// composite
boost::function<void(
    const const_image_view_t&, const const_image_view_t&, const image_view_t&, float)>
...
boost::function<void(const const_image_view_t&, const image_view_t&, float)> composite_zero_overlay
    = generic::composite_zero_overlay;
...
// key mix
boost::function<void(const const_image_view_t&,
                     const const_image_view_t&,
...
// convolve
boost::function<void(const const_image_view_t&, const image_view_t&, const Imath::M33f&)> convolve33
    = generic::convolve33;

// box blur
boost::function<void(
    const const_image_view_t&, const image_view_t&, const image_view_t&, float, float, int iters)>
    box_blur_rgba_ = sse2::box_blur_rgba;

boost::function<void(const const_channel_view_t&,
...
boost::function<void(const boost::gil::gray32fc_view_t&,
                     const boost::gil::gray32f_view_t&,
                     const boost::gil::gray32f_view_t&,
                     float,
                     float,
...
// gaussian blur
boost::function<void(
    const const_image_view_t&, const image_view_t&, const image_view_t&, float, float)>
    gaussian_blur_rgba_ = sse2::gaussian_blur_rgba;

boost::function<void(
    const const_rgb_image_view_t&, const rgb_image_view_t&, const rgb_image_view_t&, float, float)>
