...
std::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
    add_images = sse2::add_images;
std::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
    sub_images = sse2::sub_images;
std::function<void(const const_image_view_t&, const const_image_view_t&, const image_view_t&)>
                                                                           mul_images = sse2::mul_images;
std::function<void(const const_image_view_t&, float, const image_view_t&)> mul_image_scalar
...
std::function<void(const channel_view_t&)> clear_channel = generic::clear_channel;
std::function<void(const const_channel_view_t&, const const_channel_view_t&, const channel_view_t&)>
...
std::function<void(const const_channel_view_t&, float, const channel_view_t&)> mul_channel_scalar
...
std::function<void(const const_gray_image_view_t&, float, const gray_image_view_t&)>
    mul_gray_image_scalar = generic::mul_gray_image_scalar;
std::function<void(const const_gray_image_view_t&,
...
// channels
std::function<void(const const_image_view_t&, const image_view_t&)> premultiply
    = generic::premultiply;
std::function<void(const const_image_view_t&, const image_view_t&)> unpremultiply
    = generic::unpremultiply;

std::function<void(const const_image_view_t&, const image_view_t&)> invert_rgba
    = generic::invert_rgba;
std::function<void(const const_image_view_t&, const image_view_t&)> invert_rgb
    = generic::invert_rgb;
std::function<void(const const_image_view_t&, const image_view_t&)> invert_alpha
    = generic::invert_alpha;
std::function<void(const const_channel_view_t&, const channel_view_t&)> invert_channel
    = generic::invert_channel;

// color space
std::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_yuv
    = generic::convert_rgb_to_yuv;
std::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_hsv
    = generic::convert_rgb_to_hsv;
std::function<void(const const_image_view_t&, const image_view_t&)> convert_rgb_to_lab
    = generic::convert_rgb_to_lab;

std::function<void(const const_image_view_t&, const image_view_t&)> convert_yuv_to_rgb
    = generic::convert_yuv_to_rgb;
std::function<void(const const_image_view_t&, const image_view_t&)> convert_hsv_to_rgb
    = generic::convert_hsv_to_rgb;
std::function<void(const const_image_view_t&, const image_view_t&)> convert_lab_to_rgb
    = generic::convert_lab_to_rgb;

std::function<void(const const_image_view_t&, const gray_image_view_t&)> convert_rgb_to_gray
    = generic::convert_rgb_to_gray;

// color
std::function<void(const const_image_view_t&, const image_view_t&, float)> apply_gamma
    = generic::apply_gamma;
std::function<void(const const_image_view_t&, const image_view_t&)> apply_log = generic::apply_log;
std::function<void(const const_image_view_t&, const image_view_t&)> apply_pow10
    = generic::apply_pow10;
std::function<void(const const_image_view_t&, const image_view_t&, const matrix4_t&)>
...
// transform
std::function<void(const Imath::Box2i&,
...
std::function<void(const const_image_view_t&, const image_view_t&)> resize_bilinear
    = sse2::resize_bilinear;

std::function<void(const image::const_image_view_t&,
                   const Imath::Box2i&,
...
std::function<void(const const_image_view_t&, const image_view_t&, float)> composite_zero_overlay
...
// key mix
std::function<void(const const_image_view_t&,
                   const const_image_view_t&,
...
// convolve
std::function<void(const const_image_view_t&, const image_view_t&, const Imath::M33f&)> convolve33
    = generic::convolve33;
...
std::function<void(const const_channel_view_t&,
...
std::function<void(const boost::gil::gray32fc_view_t&,
                   const boost::gil::gray32f_view_t&,
                   const boost::gil::gray32f_view_t&,
                   float,
                   float,
