...
namespace image
{
template <class BlendFun = always_one> class color_correct_fun
{
  public:
    color_correct_fun(
        float       r_gamma,
      ...
      , b_lut_(blut)
    {
        ...
        identity_ =
            (r_gamma_ == 1.0f) && (g_gamma_ == 1.0f) && (b_gamma_ == 1.0f) &&
    ...
    pixel_t operator()(const pixel_t& src1, const pixel_t& src2) const
    {
        ...
        float r = lerp(
            boost::gil::get_color(src2, boost::gil::red_t()), y, saturation_);
        float g = lerp(
            boost::gil::get_color(src2, boost::gil::green_t()), y, saturation_);
        float b = lerp(
            boost::gil::get_color(src2, boost::gil::blue_t()), y, saturation_);
        ...
        {
            r = lerp(
                r, boost::gil::get_color(src2, boost::gil::red_t()), fract);
            g = lerp(
                g, boost::gil::get_color(src2, boost::gil::green_t()), fract);
            b = lerp(
                b, boost::gil::get_color(src2, boost::gil::blue_t()), fract);
        }
        ...
        boost::gil::get_color(dst, boost::gil::alpha_t()) =
            boost::gil::get_color(src2, boost::gil::alpha_t());
        return dst;
    }
