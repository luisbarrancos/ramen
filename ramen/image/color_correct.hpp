...
{
public:
    color_correct_fun(float       r_gamma,
                      float       g_gamma,
                      float       b_gamma,
                      float       r_gain,
                      float       g_gain,
    ...
    , b_lut_(blut)
    {
        ...
        if (!identity_)
        {
            r_lut_.init(boost::bind(&color_correct_fun::cc_lut_fun,
                                    this,
                                    _1,
                                    r_gamma_,
                                    r_gain_,
                        ...
                        0,
                        HALF_MAX);
            g_lut_.init(boost::bind(&color_correct_fun::cc_lut_fun,
                                    this,
                                    _1,
                                    g_gamma_,
                                    g_gain_,
                        ...
                        0,
                        HALF_MAX);
            b_lut_.init(boost::bind(&color_correct_fun::cc_lut_fun,
                                    this,
                                    _1,
                                    b_gamma_,
                                    b_gain_,
