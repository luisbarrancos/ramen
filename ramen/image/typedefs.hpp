...
#include <ramen/gil/extension/half.hpp>
...
typedef boost::gil::rgb_layout_t  rgb_layout_t;
typedef boost::gil::gray_layout_t gray_layout_t;

typedef boost::gil::pixel<channel_t, layout_t>      pixel_t;
typedef boost::gil::pixel<channel_t, rgb_layout_t>  rgb_pixel_t;
...
typedef const boost::gil::pixel<channel_t, rgb_layout_t>  const_rgb_pixel_t;
...
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_pixel_ptr_t>>
    const_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_rgb_pixel_ptr_t>>
    const_rgb_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_gray_pixel_ptr_t>>
    const_gray_locator_t;

typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<pixel_step_ptr_t>>
    step_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<rgb_pixel_step_ptr_t>>
    rgb_step_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<gray_pixel_step_ptr_t>>
    gray_step_locator_t;

typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_pixel_step_ptr_t>>
    const_step_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_rgb_pixel_step_ptr_t>>
    const_rgb_step_locator_t;
typedef boost::gil::memory_based_2d_locator<
    boost::gil::memory_based_step_iterator<const_gray_pixel_step_ptr_t>>
    const_gray_step_locator_t;

typedef boost::gil::image_view<locator_t>      image_view_t;
typedef boost::gil::image_view<rgb_locator_t>  rgb_image_view_t;
...
typedef boost::gil::image_view<const_rgb_locator_t>  const_rgb_image_view_t;
...
typedef boost::gil::image<rgb_pixel_t, false>  rgb_image_t;
typedef boost::gil::image<gray_pixel_t, false> gray_image_t;

// points, matrices, ...

typedef Imath::V2d vector2_t;
typedef Imath::V3f vector3_t;
typedef Imath::V4f vector4_t;
