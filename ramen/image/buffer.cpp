...
const_image_view_t buffer_t::const_rgba_view() const
{
    ...
    return boost::gil::interleaved_view<const_pixel_ptr_t>(
        width(),
        height(),
...
const_rgb_image_view_t buffer_t::const_rgb_view() const
{
    ...
    return boost::gil::interleaved_view<const_rgb_pixel_ptr_t>(
        width(),
        height(),
...
const_gray_image_view_t buffer_t::const_gray_view() const
{
    ...
    return boost::gil::interleaved_view<const_gray_pixel_ptr_t>(
        width(),
        height(),
...
rgb_image_view_t buffer_t::rgb_view() const
{
    ...
    return boost::gil::interleaved_view<rgb_pixel_ptr_t>(
        width(),
        height(),
...
gray_image_view_t buffer_t::gray_view() const
{
    ...
    return boost::gil::interleaved_view<gray_pixel_ptr_t>(
        width(),
        height(),
