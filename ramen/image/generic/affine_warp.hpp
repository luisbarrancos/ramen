...
{
public:
    affine_warp_fn(const Sampler&      s,
...
template<class Sampler>
void affine_warp_seq(const Sampler&      s,
...
template<class Sampler>
void affine_warp(const Sampler&      s,
                 const Imath::Box2i& src_area,
                 const Imath::Box2i& dst_area,
                 const image_view_t& dst,
                 const matrix3_t&    xform,
...
template<class Sampler>
void affine_warp_non_black_border_mode(const Sampler&      s,
                                       const Imath::Box2i& dst_area,
                                       const image_view_t& dst,
                                       const matrix3_t&    xform,
                                       const matrix3_t&    inv_xform)
