...
struct alpha_premult_fun
{
    pixel_t operator()(const pixel_t& src) const
    {
        ...
        boost::gil::get_color(r, boost::gil::red_t()) =
            boost::gil::get_color(src, boost::gil::red_t()) * a;
        boost::gil::get_color(r, boost::gil::green_t()) =
            boost::gil::get_color(src, boost::gil::green_t()) * a;
        boost::gil::get_color(r, boost::gil::blue_t()) =
            boost::gil::get_color(src, boost::gil::blue_t()) * a;
...
struct alpha_unpremult_fun
{
    pixel_t operator()(const pixel_t& src) const
    {
        ...
        if (a != 0)
        {
            float ia = 1.0f / a;
            boost::gil::get_color(r, boost::gil::red_t()) =
                boost::gil::get_color(src, boost::gil::red_t()) * ia;
            boost::gil::get_color(r, boost::gil::green_t()) =
                boost::gil::get_color(src, boost::gil::green_t()) * ia;
            boost::gil::get_color(r, boost::gil::blue_t()) =
                boost::gil::get_color(src, boost::gil::blue_t()) * ia;
            boost::gil::get_color(r, boost::gil::alpha_t()) = a;
        }
        else
        {
