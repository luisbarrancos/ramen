...
template <class ConstGrayView, class GrayView> struct gaussian_blur_gray_fn
{
    gaussian_blur_gray_fn(
...
gaussian_blur_gray_fn<ConstGrayView, GrayView> make_gaussian_blur_gray_fn(
    const ConstGrayView& src,
    const GrayView&      dst,
    float*               kernel,
    int                  size)
{
    return gaussian_blur_gray_fn<ConstGrayView, GrayView>(
        src, dst, kernel, size);
}
