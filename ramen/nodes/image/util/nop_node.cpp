...
const node_metaclass_t* nop_node_t::metaclass() const
{
    return &nop_node_metaclass();
}
...
static bool registered =
    node_factory_t::instance().register_node(nop_node_t::nop_node_metaclass());
