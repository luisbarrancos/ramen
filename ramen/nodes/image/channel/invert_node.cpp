...
const node_metaclass_t* invert_node_t::metaclass() const
{
    return &invert_node_metaclass();
}
...
static bool registered = node_factory_t::instance().register_node(
    invert_node_t::invert_node_metaclass());
