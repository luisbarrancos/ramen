...
void copy_channels_node_t::do_create_params()
{
    ...
    p->menu_items().push_back("Source");
    p->menu_items().push_back("Src2 Red");
    p->menu_items().push_back("Src2 Green");
    p->menu_items().push_back("Src2 Blue");
    p->menu_items().push_back("Src2 Luminance");
    p->menu_items().push_back("Src2 Alpha");
    p->menu_items().push_back("One");
    p->menu_items().push_back("Zero");
...
const node_metaclass_t* copy_channels_node_t::metaclass() const
{
    return &copy_channels_node_metaclass();
}
