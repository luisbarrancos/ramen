...
protected:
    ...
    matrix3_type global_matrix_at_frame(float                                     frame,
    ...
    Imath::Box2i transform_box(const Imath::Box2i& box,
...
private:
    ...
    virtual matrix3_type do_calc_transform_matrix_at_frame(float frame,
