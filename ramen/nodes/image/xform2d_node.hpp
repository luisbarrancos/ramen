...
private:
    ...
    void do_process( const render::context_t& context, const node_t *src, const image::image_view_t& dst, const matrix3_type& xf);

    void do_process_mipmap( const render::context_t& context);
    void do_process_mipmap( const render::context_t& context, const node_t *src, const image::image_view_t& dst,
