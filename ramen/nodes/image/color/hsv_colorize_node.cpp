...
#include <ramen/nodes/image/color/hsv_colorize_node.hpp>
...
const node_metaclass_t* hsv_colorize_node_t::metaclass() const
{
    return &hsv_colorize_node_metaclass();
}

const node_metaclass_t& hsv_colorize_node_t::hsv_colorize_node_metaclass()
{
