...
#include <ramen/nodes/image/tonemap/global_tonemap_node.hpp>
...
const node_metaclass_t* global_tonemap_node_t::metaclass() const
{
    return &global_tonemap_node_metaclass();
}

const node_metaclass_t& global_tonemap_node_t::global_tonemap_node_metaclass()
{
