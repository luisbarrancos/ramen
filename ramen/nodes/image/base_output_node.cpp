...
base_output_node_t::base_output_node_t() : node_t()
{
    add_input_plug( "Front", false, ui::palette_t::instance().color( "front plug"), "Front");
}

base_output_node_t::base_output_node_t( const base_output_node_t& other) : node_t( other) {}
...
{
    render::node_renderer_t r( context);
    r.render();
    write( context);
}
