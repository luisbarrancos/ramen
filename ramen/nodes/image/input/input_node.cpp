...
input_node_t::input_node_t() : node_t()
{
    set_name( "image_in");
    add_output_plug();
...
input_node_t::input_node_t( const boost::filesystem::path& path, bool sequence,
                                        const boost::filesystem::path& from_dir) : node_t()
{
    set_name( "image_in");
    add_output_plug();
    do_create_params();
...
input_node_t::input_node_t( const input_node_t& other) : node_t( other), clips_( other.clips_)
{
