//
// adapted from Anti-Grain Geometry library - Version 2-4
// by Esteban Tovagliari. Original license follows...
    ...
    T x1, T y1, T x2, T y2, const Imath::Box<Imath::Vec2<T>>& clip_box, T* x, T* y)
{
    ...
    if (deltax == 0.0)
    {
        ...
        deltax = (x1 > clip_box.min.x) ? -nearzero : nearzero;
    }

    if (deltay == 0.0)
    {
        // bump off of the horizontal
        deltay = (y1 > clip_box.min.y) ? -nearzero : nearzero;
    }
