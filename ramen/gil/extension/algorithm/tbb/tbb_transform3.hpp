...
make_tbb_transform3_pixels_fun(
    const View1& src1,
    const View2& src2,
    const View3& src3,
    const View4& dst,
    Fun          f)
{
    return tbb_transform3_pixels_fun<View1, View2, View3, View4, Fun>(
        src1, src2, src3, dst, f);
}
...
{
    tbb::parallel_for(
        tbb::blocked_range<std::size_t>(0, src1.height()),
