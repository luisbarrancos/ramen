...
{
    tbb_transform3_pixels_fun(
        const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f)
    : src1_(src1)
    , src2_(src2)
    , src3_(src3)
    , dst_(dst)
...
template<class View1, class View2, class View3, class View4, class Fun>
tbb_transform3_pixels_fun<View1, View2, View3, View4, Fun> make_tbb_transform3_pixels_fun(
    const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f)
{
...
template<class View1, class View2, class View3, class View4, class Fun>
GIL_FORCEINLINE void tbb_transform3_pixels(
    const View1& src1, const View2& src2, const View3& src3, const View4& dst, Fun f)
{
