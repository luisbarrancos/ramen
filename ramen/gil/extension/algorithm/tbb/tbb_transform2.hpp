...
make_tbb_transform2_pixels_fun(
    const View1& src1,
    const View2& src2,
    const View3& dst,
    Fun          f)
{
    return tbb_transform2_pixels_fun<View1, View2, View3, Fun>(
        src1, src2, dst, f);
}
...
template <class View1, class View2, class View3, class Fun>
GIL_FORCEINLINE void tbb_transform2_pixels(
    const View1& src1,
    const View2& src2,
    const View3& dst,
    Fun          f)
