...
template <
    typename PixelRef1,  // models pixel concept
...
template <
    typename PixelRef,  // models pixel concept
...
struct pixel_halves_t
{
    ...
    {
        static_for_each(
            p, channel_halves_t<typename channel_type<PixelRef>::type>());
        return p;
    }
};
...
struct pixel_zeros_t
{
    ...
    {
        static_for_each(
            p, channel_zeros_t<typename channel_type<PixelRef>::type>());
        return p;
    }
};
