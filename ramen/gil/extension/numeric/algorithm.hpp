...
inline DstIterator assign_pixels(
    SrcIterator src,
    SrcIterator src_end,
    DstIterator dst)
{
    for_each(
        ...
        pixel_assigns_t<
            ...
            typename pixel_proxy<typename std::iterator_traits<
                DstIterator>::value_type>::type>());
...
template <
    ...
    class _BinaryOperation1,
    class _BinaryOperation2>
GIL_FORCEINLINE _Tp inner_product_k(
    _InputIterator1   __first1,
    _InputIterator2   __first2,
    _Tp               __init,
    _BinaryOperation1 __binary_op1,
...
inline DstIterator correlate_pixels_n(
    ...
    DstIterator    dst_begin)
{
    ...
    typedef typename pixel_proxy<
        ...
        PIXEL_DST_REF;
    typedef
        typename std::iterator_traits<KernelIterator>::value_type kernel_type;
    PixelAccum                                                    acc_zero;
...
template <
    ...
    typename KernelIterator,
    typename DstIterator>
inline DstIterator correlate_pixels_k(
    SrcIterator    src_begin,
    SrcIterator    src_end,
    KernelIterator ker_begin,
    DstIterator    dst_begin)
