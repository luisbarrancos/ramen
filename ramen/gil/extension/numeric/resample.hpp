...
///////////////////////////////////////////////////////////////////////////
////
////  resample_pixels: set each pixel in the destination view as the result of a
///sampling function
    ...
    Sampler        sampler = Sampler())
{
    ...
    for (dst_p.y = 0; dst_p.y < dst_dims.y; ++dst_p.y)
    {
        ...
        {
            sample(
                sampler, src_view, transform(dst_to_src, dst_p), xit[dst_p.x]);
        }
    }
}
  ...
  : public binary_operation_obj<resample_pixels_fn<Sampler, MapFn>>
{
    ...
    GIL_FORCEINLINE void apply_compatible(
        const SrcView& src,
