...
{
    return ui_.output_popup_->currentIndex() == 1;
}

int render_composition_dialog_t::mblur_extra_samples() const
{
    return ui_.mblur_extra_samples_->value();
}
float render_composition_dialog_t::mblur_shutter_factor() const
{
