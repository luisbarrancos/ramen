...
namespace undo
{
extract_command_t::extract_command_t()
  : command_t("Extract")
{
}

void extract_command_t::add_edge_to_remove(const edge_t& e)
{
    edges_to_remove_.push_back(e);
}
void extract_command_t::add_edge_to_add(const edge_t& e)
{
    edges_to_add_.push_back(e);
}
...
void extract_command_t::add_candidate_edge(
    const edge_t&        e,
    node_t*              src,
...
void extract_command_t::undo()
{
    ...
    boost::range::for_each(
        edges_to_add_,
        boost::bind(&composition_t::remove_edge, comp, _1, true));
    boost::range::for_each(
        edges_to_remove_,
        boost::bind(&composition_t::add_edge, comp, _1, true));
    breadth_first_multiple_outputs_search(
        dependents_, boost::bind(&node_t::notify, _1));
    command_t::undo();
}
...
void extract_command_t::redo()
{
    ...
    boost::range::for_each(
        ...
        boost::bind(&composition_t::remove_edge, comp, _1, true));
    boost::range::for_each(
        edges_to_add_, boost::bind(&composition_t::add_edge, comp, _1, true));
    breadth_first_multiple_outputs_search(
        dependents_, boost::bind(&node_t::notify, _1));
    command_t::redo();
}
...
duplicate_command_t::duplicate_command_t()
  : command_t("Duplicate")
{
}
...
void duplicate_command_t::undo()
{
    ...
    composition_t* comp = &app().document().composition();
    boost::range::for_each(
        edges_, boost::bind(&composition_t::remove_edge, comp, _1, true));
    command_t::undo();
}
...
void duplicate_command_t::redo()
{
    ...
    composition_t* comp = &app().document().composition();
    boost::range::for_each(
        edges_, boost::bind(&composition_t::add_edge, comp, _1, true));
    command_t::redo();
}

ignore_nodes_command_t::ignore_nodes_command_t()
  : command_t("Ignore")
{
}
...
void ignore_nodes_command_t::undo()
{
    ...
    breadth_first_multiple_outputs_search(
        nodes_, boost::bind(&node_t::notify, _1));
    command_t::undo();
}
