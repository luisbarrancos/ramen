...
{
    return Imath::Box2i(Imath::V2i(box.min.x, box.min.y), Imath::V2i(box.max.x, box.max.y));
}
                                  ...
                                  const core::dictionary_t&        params) const
{
    ...
    {
        const math::box2i_t* tmp = core::get<math::box2i_t>(&params, core::name_t("bounds"));
    ...
    image::const_image_view_t subview(
                                    ...
                                    const image::const_image_view_t& view) const
{
    ...
    boost::gil::copy_and_convert_pixels(boost::gil::nth_channel_view(view, 3),
                                        boost::gil::view(img));
