...
core::string8_t keyframe_t::auto_tangent_to_string( auto_tangent_method t) const
{
    switch( t)
    {
        case tangent_step:
...
keyframe_t::auto_tangent_method keyframe_t::string_to_auto_tangent( const core::string8_t& s) const
{
    if( s == "step")
        return tangent_step;
