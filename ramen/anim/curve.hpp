...
protected:
    ...
    core::string8_t extrapolation_method_to_string( extrapolation_method t) const
    {
        switch( t)
        {
    ...
    extrapolation_method string_to_extrapolation_method( const core::string8_t& s) const
    {
        if( s == "constant")
