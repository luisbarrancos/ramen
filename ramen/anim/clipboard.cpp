...
void clipboard_t::copy_curve( const core::string8_t& name, const anim::any_curve_ptr_t& c)
{
...
void clipboard_t::copy_keys( const core::string8_t& name, const anim::any_curve_ptr_t& c)
{
    RAMEN_ASSERT( copying_);
...
bool clipboard_t::can_paste( const core::string8_t& name, const anim::any_curve_ptr_t& c)
{
    return find_compatible_curve( name, c) != -1;
}

void clipboard_t::paste( const core::string8_t& name, anim::any_curve_ptr_t& c, float frame)
{
    RAMEN_ASSERT( !copying_);
...
int clipboard_t::find_compatible_curve( const core::string8_t& name, const anim::any_curve_ptr_t& c)
{
    if( empty())
        return -1;
